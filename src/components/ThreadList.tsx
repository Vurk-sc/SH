...
export default function ThreadList({ refreshTrigger }: ThreadListProps) {
        ...
        <div className="text-center py-16 bg-gray-800 border border-gray-700">
          <div className="w-20 h-20 bg-gray-700 mx-auto mb-4 flex items-center justify-center">
            <svg className="w-10 h-10 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 002-2v-1a2 2 0 012-2H3.055M9 3v4a2 2 0 002 2v-1a2 2 0 012-2H3.055M9 3v4a2 2 0 002-2V3m-6 8h6" />
            </svg>
          </div>
          ...
          >
            <div className="p-6">
              <div className="flex justify-between items-start mb-4">
                ...
                {thread.is_private && (
                  <span className="bg-yellow-600 text-yellow-100 text-xs px-3 py-1 ml-3 flex items-center">
                    <svg className="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2h5l2 2h5a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 00-2-2H6a2 2 0 002-2v-1a2 2 0 012-2H3.055M9 3v4a2 2 0 002-2V3m-6 8h6" clipRule="evenodd" />
                    </svg>
                    Private
                  </span>
                )}
